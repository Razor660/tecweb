<?php
// Muestra productos vigentes y añade un botón para modificar cada uno.
    ...
    <tbody>
        <?php
            ...
            while ($p = $stmt->fetch()) {
                ...
                echo '<td><img src="' . htmlspecialchars($p['imagen'] ?? '') . '" width="50"></td>';
                
                // Formulario para enviar datos a la página de edición
                echo '<td>';
